...
data = [
    ...
    {"id": 1, "name": "张三", "ename": "zs1", "age": 23, "intro": "喜欢爬山，喜欢运动，喜欢一个人去旅行"},
    ...
    {"index": {"_index": index, "_type": index, "_id": "11"}},
    {"id": 11, "name": "zz10", "ename": "赵六10", "age": 36, "intro": "老6 10",
     "address": {"province": "北京", "city": "北京"}},
]
es.bulk(data)
...
print(ess.bool_must(index, queries))
print(ess.bool_should(index, queries))
print(ess.bool_must_not(index, queries))
